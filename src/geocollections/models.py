...
class Geocollection(models.Model):
    ...
    def remove_object_permissions(self):
        """
        Resets completely the permissions assigned to this object.
        """
    ...
    def set_permissions(self, perm_spec):
        """
        Set custom permissions given a JSON 'perm_spec'
        """
    ...
    def get_all_level_info(self):
        """
        Prints out the current assigned permissions as a JSON 'perm_spec' output
        """
    ...
    def get_self_resource(self):
        """
        Returns the concrete instance of the connected ResourceBase
        """
        try:
